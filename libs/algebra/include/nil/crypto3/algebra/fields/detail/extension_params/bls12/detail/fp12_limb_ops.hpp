...
#include <nil/crypto3/algebra/fields/detail/extension_params/bls12/detail/fp12_limb_ops_x86.hpp>
#endif
...
namespace nil::crypto3::algebra::fields::detail::bls12_fp12_limb_ops {
    ...
    static limb_array load_limbs(const Backend &backend) {
        static_assert(Backend::limb_bits == limb_bits, "bls12 fp12 fast path expects 64-bit field limbs");
        static_assert(Backend::internal_limb_count == base_value_limb_count,
                      "bls12 fp12 fast path expects 4 64-bit limbs");
        limb_array result = {};
    ...
    // common path for products of ordinary BLS12 Fp Montgomery residues.
    ...
    // Raw fp2_base coefficient-wise add. BLS12 inputs are bounded so each
