...
#ifndef CRYPTO3_BLOCK_ARIA_HPP
#define CRYPTO3_BLOCK_ARIA_HPP
        ...
        namespace block {
            ...
            protected:
                ...
                void schedule_key(const key_type &key) {
                    ...
                    policy_type::template rol128<19>(w0, w1, &encryption_round_key[0]);
                    policy_type::template rol128<19>(w1, w2, &encryption_round_key[4]);
                    policy_type::template rol128<19>(w2, w3, &encryption_round_key[8]);
                    policy_type::template rol128<19>(w3, w0, &encryption_round_key[12]);
                    policy_type::template rol128<31>(w0, w1, &encryption_round_key[16]);
                    policy_type::template rol128<31>(w1, w2, &encryption_round_key[20]);
                    policy_type::template rol128<31>(w2, w3, &encryption_round_key[24]);
                    policy_type::template rol128<31>(w3, w0, &encryption_round_key[28]);
                    policy_type::template rol128<67>(w0, w1, &encryption_round_key[32]);
                    policy_type::template rol128<67>(w1, w2, &encryption_round_key[36]);
                    policy_type::template rol128<67>(w2, w3, &encryption_round_key[40]);
                    policy_type::template rol128<67>(w3, w0, &encryption_round_key[44]);
                    policy_type::template rol128<97>(w0, w1, &encryption_round_key[48]);

                    if (policy_type::key_bits / CHAR_BIT == 24 || policy_type::key_bits / CHAR_BIT == 32) {
                        policy_type::template rol128<97>(w1, w2, &encryption_round_key[52]);
                        policy_type::template rol128<97>(w2, w3, &encryption_round_key[56]);

                        if (policy_type::key_bits / 8 == 32) {
                            policy_type::template rol128<97>(w3, w0, &encryption_round_key[60]);
                            policy_type::template rol128<109>(w0, w1, &encryption_round_key[64]);
                        }
                    }
                    ...
                    for (size_t i = 4; i != decryption_round_key.size() - 4; i += 4) {
                        for (size_t j = 0; j != 4; ++j) {
                            decryption_round_key[i + j] = policy_type::template rotr<8>(decryption_round_key[i + j]) ^
                                                          policy_type::template rotr<16>(decryption_round_key[i + j]) ^
                                                          policy_type::template rotr<24>(decryption_round_key[i + j]);
                        }
                        ...
                        decryption_round_key[i + 2] = policy_type::template rotr<16>(decryption_round_key[i + 2]);
                        decryption_round_key[i + 3] = boost::endian::endian_reverse(decryption_round_key[i + 3]);
                ...
                block_type transform(const block_type &plaintext, const key_schedule_type &schedule) const {
                    ...
                    return {
                        ::nil::crypto3::detail::make_uint_t<word_bits>(
                            policy_type::x1[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t0, 0)] ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds], 0),
                            policy_type::x2[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t0, 1)] >> 8 ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds], 1),
                            policy_type::s1[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t0, 2)] ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds], 2),
                            policy_type::s2[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t0, 3)] ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds], 3)),
                        ::nil::crypto3::detail::make_uint_t<word_bits>(
                            policy_type::x1[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t1, 0)] ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds + 1], 0),
                            policy_type::x2[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t1, 1)] >> 8 ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds + 1], 1),
                            policy_type::s1[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t1, 2)] ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds + 1], 2),
                            policy_type::s2[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t1, 3)] ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds + 1], 3)),
                        ::nil::crypto3::detail::make_uint_t<word_bits>(
                            policy_type::x1[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t2, 0)] ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds + 2], 0),
                            policy_type::x2[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t2, 1)] >> 8 ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds + 2], 1),
                            policy_type::s1[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t2, 2)] ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds + 2], 2),
                            policy_type::s2[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t2, 3)] ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds + 2], 3)),
                        ::nil::crypto3::detail::make_uint_t<word_bits>(
                            policy_type::x1[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t3, 0)] ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds + 3], 0),
                            policy_type::x2[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t3, 1)] >> 8 ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds + 3], 1),
                            policy_type::s1[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t3, 2)] ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds + 3], 2),
                            policy_type::s2[::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(t3, 3)] ^
                            ::nil::crypto3::detail::extract_uint_t<CHAR_BIT>(schedule[4 * rounds + 3], 3))
                    };
                }
            };
        } // namespace block
