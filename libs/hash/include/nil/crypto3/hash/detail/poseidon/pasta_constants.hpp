    ...
    namespace crypto3 {
        namespace hashes {
            namespace detail {
                ...
                // All constants are taken from the Mina
                // implementation(https://github.com/o1-labs/proof-systems/blob/a36c088b3e81d17f5720abfff82a49cf9cb1ad5b/poseidon/src/pasta/)
                // and converted from dec to hex.
                template<typename FieldType, std::size_t Rate>
                struct poseidon_pasta_constants_data_base;

                template<>
                struct poseidon_pasta_constants_data_base<typename nil::crypto3::algebra::fields::pallas_base_field,
                                                          2> {
                    ...
                    constexpr static const std::array<std::array<typename FieldType::value_type, state_words>,
                                                      state_words>
                        mds_matrix = {{
                    ...
                    constexpr static const std::array<std::array<typename FieldType::value_type, state_words>,
                        ...
                        round_constants = {{
                            ...
                            {{0x380bd03b840c48c8ba3830e7cace72f91a5002218c617294e8c8bc687d5216de_cppui_modular255,
                              0x2c6e57ddc1d7c81a0299ed49c3d74759416bc8426f30e2af5622895c531b4e1c_cppui_modular255,
                ...
                template<typename poseidon_policy_type>
                struct poseidon_pasta_constants_data
                    : poseidon_pasta_constants_data_base<typename poseidon_policy_type::field_type,
