        ...
        namespace hashes {
            namespace detail {
                ...
                template<typename FieldType, std::size_t Security, std::size_t Rate, std::size_t Capacity,
                         std::size_t SBoxPower, std::size_t FullRounds, std::size_t PartRounds, bool PastaVersion>
                ...
                struct poseidon_policy<FieldType, 80, Rate, std::enable_if_t<Rate == 1 || Rate == 2>>
                    : base_poseidon_policy<FieldType, 80, Rate, 1, 5, 8, 33, false> { };

                template<typename FieldType>
                struct poseidon_policy<FieldType, 80, 4> : base_poseidon_policy<FieldType, 80, 4, 1, 5, 8, 35, false> {
                };

                template<typename FieldType, std::size_t Rate>
                struct poseidon_policy<FieldType, 128, Rate, std::enable_if_t<Rate == 1 || Rate == 2>>
                ...
                template<typename FieldType, std::size_t Rate>
                struct poseidon_policy<FieldType, 256, Rate, std::enable_if_t<Rate <= 4>>
