        ...
        namespace hashes {
            namespace detail {
                ...
                public:
                    ...
                    using mds_matrix_type = math::static_matrix<element_type, state_words, state_words>;
                    using round_constants_type =
                        math::static_matrix<element_type, full_rounds + part_rounds, state_words>;
