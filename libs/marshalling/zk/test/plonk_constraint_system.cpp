...
struct plonk_constraint_system_test_runner {
    ...
    bool run_test() {
        ...
        using value_marshalling_type =
            nil::crypto3::marshalling::types::plonk_constraint_system<TTypeBase, constraint_system>;

        auto filled_val =
            nil::crypto3::marshalling::types::fill_plonk_constraint_system<Endianness, constraint_system>(system);
...
using TestRunners = boost::mpl::list<
    ...
    plonk_constraint_system_test_runner<alt_bn_scalar_field, poseidon_over_alt_bn, poseidon_over_alt_bn>,
