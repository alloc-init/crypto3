...
BOOST_AUTO_TEST_CASE(evaluation_layouts) {
    ...
    BOOST_CHECK_EQUAL(combination.evaluate_with_constant_slot(witness), value_type(110));
}
...
BOOST_AUTO_TEST_CASE(evaluation_over_extension_field) {
    ...
    using base_combination_type = nil::crypto3::math::linear_combination<base_variable_type>;
    ...
    BOOST_CHECK_EQUAL(combination.evaluate_with_constant_slot(witness), expected);
}
