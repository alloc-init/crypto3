...
namespace boost {
    namespace multiprecision {
        namespace backends {
            ...
            BOOST_MP_CXX14_CONSTEXPR void bitwise_op(cpp_int_modular_backend<Bits>& result,
                                                     const cpp_int_modular_backend<Bits>& o,
                                                     Op op) noexcept {
                //
            ...
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<
                ...
                !boost::multiprecision::backends::is_trivial_cpp_int_modular<cpp_int_modular_backend<Bits>>::value>::
                type
                eval_bitwise_and(cpp_int_modular_backend<Bits>& result,
            ...
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<
                ...
                !boost::multiprecision::backends::is_trivial_cpp_int_modular<cpp_int_modular_backend<Bits>>::value>::
                type
                eval_bitwise_or(cpp_int_modular_backend<Bits>& result,
                                const cpp_int_modular_backend<Bits>& o) noexcept {
            ...
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<
                ...
                !boost::multiprecision::backends::is_trivial_cpp_int_modular<cpp_int_modular_backend<Bits>>::value>::
                type
                eval_bitwise_xor(cpp_int_modular_backend<Bits>& result,
                                 const cpp_int_modular_backend<Bits>& o) noexcept {
            ...
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                ...
                eval_bitwise_and(cpp_int_modular_backend<Bits>& result, limb_type l) noexcept {
                result.limbs()[0] &= l;
                result.zero_after(1);
            }
            ...
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR
                typename std::enable_if<!boost::multiprecision::backends::is_trivial_cpp_int_modular<
                    cpp_int_modular_backend<Bits>>::value>::type
                eval_complement(cpp_int_modular_backend<Bits>& result,
                                const cpp_int_modular_backend<Bits>& o) noexcept {
            ...
            // Left shift will throw away upper bits.
            // This function must be called only when s % limb_bits == 0, i.e. we shift limbs, which are normally 64
            // bit.
            template<unsigned Bits>
            inline BOOST_MP_CXX14_CONSTEXPR void left_shift_limb(cpp_int_modular_backend<Bits>& result,
                                                                 double_limb_type s) {
                typedef cpp_int_modular_backend<Bits> Int;
            ...
            // Left shift will throw away upper bits.
            template<unsigned Bits>
            inline BOOST_MP_CXX14_CONSTEXPR void left_shift_generic(cpp_int_modular_backend<Bits>& result,
                                                                    double_limb_type s) {
                typedef cpp_int_modular_backend<Bits> Int;
...
#else
                BOOST_MP_CXX14_CONSTEXPR limb_type limb_shift_mask = cpp_int_modular_backend<Bits>::limb_bits - 1;
            ...
            template<unsigned Bits>
            inline BOOST_MP_CXX14_CONSTEXPR void right_shift_limb(cpp_int_modular_backend<Bits>& result,
                                                                  double_limb_type s) {
                typedef cpp_int_modular_backend<Bits> Int;
            ...
            template<unsigned Bits>
            inline BOOST_MP_CXX14_CONSTEXPR void right_shift_generic(cpp_int_modular_backend<Bits>& result,
                                                                     double_limb_type s) {
                typedef cpp_int_modular_backend<Bits> Int;
                limb_type offset = static_cast<limb_type>(s / Int::limb_bits);
                limb_type shift = static_cast<limb_type>(s % Int::limb_bits);
            ...
            inline BOOST_MP_CXX14_CONSTEXPR
                typename std::enable_if<!boost::multiprecision::backends::is_trivial_cpp_int_modular<
                    cpp_int_modular_backend<Bits>>::value>::type
                eval_right_shift(cpp_int_modular_backend<Bits>& result, double_limb_type s) noexcept {
                if (!s)
                    return;
            ...
            BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<
                ...
                *result.limbs() =
                    (static_cast<unsigned>(s) >= sizeof(*result.limbs()) * CHAR_BIT) ? 0 : (*result.limbs() >> s);
            }
            ...
            inline BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<
                ...
                boost::multiprecision::is_unsigned_number<cpp_int_modular_backend<Bits>>::value>::type
                eval_complement(cpp_int_modular_backend<Bits>& result,
                                const cpp_int_modular_backend<Bits>& o) noexcept {
