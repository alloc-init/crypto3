...
namespace boost {
    namespace multiprecision {
        namespace detail {
            ...
            void assign_bits(boost::multiprecision::backends::cpp_int_modular_backend<Bits>& val, Unsigned bits,
            ...
            void assign_bits(boost::multiprecision::backends::cpp_int_modular_backend<Bits>& val,
                             std::__bit_const_reference<std::vector<bool>> bits, std::size_t bit_location,
            ...
            void assign_bits(boost::multiprecision::backends::cpp_int_modular_backend<Bits>& val, Unsigned bits,
                ...
                using local_limb_type =
                    typename boost::multiprecision::backends::cpp_int_modular_backend<Bits>::local_limb_type;
                //
            ...
            number<boost::multiprecision::backends::cpp_int_modular_backend<Bits>, ExpressionTemplates>&
                ...
                while (i != j) {
                    assign_bits(newval, *i, static_cast<std::size_t>(bit_location), chunk_size, tag_type());
                    ++i;
            ...
            inline typename std::enable_if<
                !boost::multiprecision::backends::is_trivial_cpp_int_modular<
                    boost::multiprecision::backends::cpp_int_modular_backend<Bits>>::value,
                number<boost::multiprecision::backends::cpp_int_modular_backend<Bits>, ExpressionTemplates>&>::type
                import_bits_fast(
                    number<boost::multiprecision::backends::cpp_int_modular_backend<Bits>, ExpressionTemplates>& val,
        ...
        template<unsigned Bits, expression_template_option ExpressionTemplates, class Iterator>
        inline number<boost::multiprecision::backends::cpp_int_modular_backend<Bits>, ExpressionTemplates>& import_bits(
            number<boost::multiprecision::backends::cpp_int_modular_backend<Bits>, ExpressionTemplates>& val,
            Iterator i, Iterator j, std::size_t chunk_size = 0, bool msv_first = true) {
        ...
        template<unsigned Bits, expression_template_option ExpressionTemplates, class T>
        inline number<boost::multiprecision::backends::cpp_int_modular_backend<Bits>, ExpressionTemplates>& import_bits(
            number<boost::multiprecision::backends::cpp_int_modular_backend<Bits>, ExpressionTemplates>& val, T* i,
            T* j, std::size_t chunk_size = 0, bool msv_first = true) {
        ...
        template<unsigned Bits, expression_template_option ExpressionTemplates, class OutputIterator>
...
#pragma warning(disable : 4244)
            ...
            const std::ptrdiff_t bit_step = msv_first ?
                                                static_cast<std::ptrdiff_t>(-static_cast<std::ptrdiff_t>(chunk_size)) :
