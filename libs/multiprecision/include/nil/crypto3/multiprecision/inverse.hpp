    ...
    namespace multiprecision {
        ...
        BOOST_MP_CXX14_CONSTEXPR boost::multiprecision::number<Backend, ExpressionTemplates>
            inverse_extended_euclidean_algorithm(
                const boost::multiprecision::number<Backend, ExpressionTemplates> &n,
        ...
        BOOST_MP_CXX14_CONSTEXPR
            boost::multiprecision::number<backends::modular_adaptor<Backend, StorageType>, ExpressionTemplates>
            inverse_extended_euclidean_algorithm(
                const boost::multiprecision::number<backends::modular_adaptor<Backend, StorageType>,
                                                    ExpressionTemplates> &modular) {
        ...
        BOOST_MP_CXX14_CONSTEXPR
            boost::multiprecision::number<backends::modular_adaptor<Backend, StorageType>, ExpressionTemplates>
            inverse_mod(const boost::multiprecision::number<backends::modular_adaptor<Backend, StorageType>,
                                                            ExpressionTemplates> &modular) {
