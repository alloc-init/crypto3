    ...
    namespace multiprecision {
        namespace backends {
            ...
            BOOST_MP_CXX14_CONSTEXPR
                typename boost::enable_if_c<is_trivial_cpp_int_modular<Backend>::value, std::size_t>::type
                get_limbs_count() {
                return 1u;
            }
            ...
            BOOST_MP_CXX14_CONSTEXPR
                typename boost::enable_if_c<is_trivial_cpp_int_modular<Backend>::value, std::size_t>::type
                get_limb_bits() {
                return sizeof(typename trivial_limb_type<
            ...
            struct modular_policy<cpp_int_modular_backend<Bits>> {
                ...
                typedef typename std::conditional<is_trivial_cpp_int_modular<Backend>::value,
                                                  typename trivial_limb_type<Bits>::type, limb_type>::type
                    internal_limb_type;

                typedef
                    typename std::conditional<is_trivial_cpp_int_modular<Backend>::value,
                                              typename trivial_limb_type<2u * limb_bits>::type, double_limb_type>::type
                ...
                BOOST_MP_CXX14_CONSTEXPR static auto BitsCount_doubled_padded_limbs =
