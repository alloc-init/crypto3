...
BOOST_AUTO_TEST_CASE(ressol_runtime_4_bit_tests) {
    ...
    // When there is no square root, we return 0 now, not -1. This will change when proper error management is
    // introduced.
...
//     constexpr auto p10 =
//     0x40000000000000000000000000000000000000000000000000000000000c100000000000000ffff_cppui_modular315; constexpr
//     auto res10 = 0x20_cppui_modular315; static_assert(ressol(a10, p10) == res10, "ressol error");
//
...
//     constexpr auto p12 =
//     0x40000000000000000000000000000000000000000000000000000000000c100000000000000ffff_cppui_modular315; constexpr
//     auto res12 = 0xdcc6506af06fe9e142cacb7b5ff56c1864fe7a0b2f7fb10739990aed564e07beb533b5edd95fa3_cppui_modular315;
//     static_assert(ressol(a12, p12) == res12, "ressol error");
//
//     constexpr auto a13 = 0x10_cppui_modular315;
//     constexpr auto p13 =
//     0x40000000000000000000000000000000000000000000000000000000000c100000000000000ffff_cppui_modular315; constexpr
//     auto res13 = 0x4_cppui_modular315; static_assert(ressol(a13, p13) == res13, "ressol error");
//
//     constexpr auto a14 = 0x733f6e1_cppui_modular315;
//     constexpr auto p14 =
//     0x40000000000000000000000000000000000000000000000000000000000c100000000000000ffff_cppui_modular315; constexpr
//     auto res14 = 0x40000000000000000000000000000000000000000000000000000000000c100000000000000d50e_cppui_modular315;
...
//     constexpr auto a5_m = number<modular_adaptor_type_7>(modular_adaptor_type_7(0x40_cppui_modular7,
//     0x55_cppui_modular7)); constexpr auto negone_5 = number<modular_adaptor_type_7>(modular_adaptor_type_7(0,
//     0x55_cppui_modular7)); static_assert(ressol(a5_m) == negone_5, "ressol error");
//
...
//
//     constexpr auto a7_m =
//         number<backends::modular_adaptor<cpp16, backends::modular_params_rt<cpp16>>>(0x1081_cppui_modular16,
//         0x8181_cppui_modular16);
//     constexpr auto negone_7 =
//         number<backends::modular_adaptor<cpp16, backends::modular_params_rt<cpp16>>>(number<cpp16>(-1),
//         0x8181_cppui_modular16);
//     static_assert(ressol(a7_m) == negone_7, "ressol error");
//
//     constexpr auto a8_m =
//         number<backends::modular_adaptor<cpp15, backends::modular_params_rt<cpp15>>>(0x800_cppui_modular15,
//         0x7ab9_cppui_modular15);
...
//
//     constexpr auto a9_m =
//         number<backends::modular_adaptor<cpp13, backends::modular_params_rt<cpp13>>>(0x2_cppui_modular13,
//         0x1111_cppui_modular13);
...
//         number<backends::modular_adaptor<cpp18, backends::modular_params_rt<cpp18>>>(0x400_cppui_modular18,
...
//         0x401_cppui_modular315,
//         0x40000000000000000000000000000000000000000000000000000000000c100000000000000ffff_cppui_modular315);
//     constexpr auto res12 =
//     0xdcc6506af06fe9e142cacb7b5ff56c1864fe7a0b2f7fb10739990aed564e07beb533b5edd95fa3_cppui_modular315;
...
//         0x733f6e1_cppui_modular315,
//         0x40000000000000000000000000000000000000000000000000000000000c100000000000000ffff_cppui_modular315);
//     constexpr auto res14 =
//     0x40000000000000000000000000000000000000000000000000000000000c100000000000000d50e_cppui_modular315;
