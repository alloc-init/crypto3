...
void test() {
    ...
    val = 2.5;
    BOOST_CHECK_CLOSE_FRACTION(asinh(val),
                               T("1."
                                 "6472311463710957106248586104436196635044144301932365282203100930843983757633104078778"
                                 "4202550694249077770061320755164847787553605959131722990938295229503978956996195405235"
                                 "79875476513967578478619028438291006578604823887119907434"),
                               s);
    BOOST_CHECK_CLOSE_FRACTION(asinh(val + T(0)),
                               T("1."
                                 "6472311463710957106248586104436196635044144301932365282203100930843983757633104078778"
                                 "4202550694249077770061320755164847787553605959131722990938295229503978956996195405235"
                                 "79875476513967578478619028438291006578604823887119907434"),
                               s);
    BOOST_CHECK_CLOSE_FRACTION(acosh(val),
                               T("1."
                                 "5667992369724110786640568625804834938620823510926588639329459980122148134693922696279"
                                 "9684996222011410510391840509363110664535653863932403565623743024178433194802232118576"
                                 "15778787272615171906055455922537080327062362258846337050"),
                               s);
    BOOST_CHECK_CLOSE_FRACTION(acosh(val + T(0)),
                               T("1."
                                 "5667992369724110786640568625804834938620823510926588639329459980122148134693922696279"
                                 "9684996222011410510391840509363110664535653863932403565623743024178433194802232118576"
                                 "15778787272615171906055455922537080327062362258846337050"),
                               s);
    val = 0.5;
    BOOST_CHECK_CLOSE_FRACTION(atanh(val),
                               T("0."
                                 "5493061443340548456976226184612628523237452789113747258673471668187471466093044834368"
                                 "0787740686604439398501453297893287118400211296525991052640093538363870530158138459169"
                                 "06835896868494221804799518712851583979557605727959588753"),
                               s);
    BOOST_CHECK_CLOSE_FRACTION(atanh(val + T(0)),
                               T("0."
                                 "5493061443340548456976226184612628523237452789113747258673471668187471466093044834368"
                                 "0787740686604439398501453297893287118400211296525991052640093538363870530158138459169"
                                 "06835896868494221804799518712851583979557605727959588753"),
                               s);
    val = 55.25;
    BOOST_CHECK_CLOSE_FRACTION(cbrt(val),
                               T("3."
                                 "8087058015466360309383876359583281382991983919300128125378938779672144843676192684301"
                               ...
                               s);
    BOOST_CHECK_CLOSE_FRACTION(cbrt(val + T(0)),
                               T("3."
                                 "8087058015466360309383876359583281382991983919300128125378938779672144843676192684301"
                                 "1684796572794981207674247240249653198692487974232760640156433614261895764156709178183"
                                 "13417529572608229017809069355688606687557031643655896118"),
    ...
    if (!boost::multiprecision::is_interval_number<T>::value) {
        ...
        BOOST_CHECK_CLOSE_FRACTION(erf(val),
                                   T("0."
                                     "999899378077880363163095608024913043234935262142264065516109579465452642202590896"
                                     "144732829668105689297521434477930073462025539168271351926504849619903496370697642"
                                     "0982849598189071465666866369396765001072187538732800143945532487"),
                                   s);
        BOOST_CHECK_CLOSE_FRACTION(erf(val + T(0)),
                                   T("0."
                                     "999899378077880363163095608024913043234935262142264065516109579465452642202590896"
                                     "144732829668105689297521434477930073462025539168271351926504849619903496370697642"
                                     "0982849598189071465666866369396765001072187538732800143945532487"),
                                   s);
        BOOST_CHECK_CLOSE_FRACTION(erfc(val),
                                   T("0."
                                     "000100621922119636836904391975086956765064737857735934483890420534547357797409103"
                                     "855267170331894310702478565522069926537974460831728648073495150380096503629302357"
                                     "9017150401810928534333133630603234998927812461267199856054467512"),
                                   s);
        BOOST_CHECK_CLOSE_FRACTION(erfc(val + T(0)),
                                   T("0."
                                     "000100621922119636836904391975086956765064737857735934483890420534547357797409103"
                                     "855267170331894310702478565522069926537974460831728648073495150380096503629302357"
                                     "9017150401810928534333133630603234998927812461267199856054467512"),
    ...
    val = 0.125;
    BOOST_CHECK_CLOSE_FRACTION(expm1(val),
                               T("0."
                                 "1331484530668263168290072278117938725655031317451816259128200360788235778800483865139"
                                 "3999079494172857323152701564730756570482104525847339987855640259169952611627592807003"
                                 "97984729320345630340659469435372721057879969170503978449"),
                               s);
    BOOST_CHECK_CLOSE_FRACTION(expm1(val + T(0)),
                               T("0."
                                 "1331484530668263168290072278117938725655031317451816259128200360788235778800483865139"
                                 "3999079494172857323152701564730756570482104525847339987855640259169952611627592807003"
                                 "97984729320345630340659469435372721057879969170503978449"),
    ...
    s = 2;
    BOOST_CHECK_CLOSE_FRACTION(T(hypot(val, s)),
                               T("20."
                                 "0997512422417805404385298255191523738900469400527545811456565946569824631039407624723"
                                 "55384907904704732599006530"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(T(hypot(val, 2)),
                               T("20."
                                 "0997512422417805404385298255191523738900469400527545811456565946569824631039407624723"
                                 "55384907904704732599006530"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(T(hypot(val, 2.0)),
                               T("20."
                                 "0997512422417805404385298255191523738900469400527545811456565946569824631039407624723"
                                 "55384907904704732599006530"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(T(hypot(20, s)),
                               T("20."
                                 "0997512422417805404385298255191523738900469400527545811456565946569824631039407624723"
                                 "55384907904704732599006530"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(T(hypot(20.0, s)),
                               T("20."
                                 "0997512422417805404385298255191523738900469400527545811456565946569824631039407624723"
                                 "55384907904704732599006530"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(T(hypot(val * 1, s)),
                               T("20."
                                 "0997512422417805404385298255191523738900469400527545811456565946569824631039407624723"
                                 "55384907904704732599006530"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(T(hypot(val * 1, s * 1)),
                               T("20."
                                 "0997512422417805404385298255191523738900469400527545811456565946569824631039407624723"
                                 "55384907904704732599006530"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(T(hypot(val * 1, 2)),
                               T("20."
                                 "0997512422417805404385298255191523738900469400527545811456565946569824631039407624723"
                                 "55384907904704732599006530"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(T(hypot(val * 1, 2.0)),
                               T("20."
                                 "0997512422417805404385298255191523738900469400527545811456565946569824631039407624723"
                                 "55384907904704732599006530"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(T(hypot(20, s * 1)),
                               T("20."
                                 "0997512422417805404385298255191523738900469400527545811456565946569824631039407624723"
                                 "55384907904704732599006530"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(T(hypot(20.0, s * 1)),
                               T("20."
                                 "0997512422417805404385298255191523738900469400527545811456565946569824631039407624723"
                                 "55384907904704732599006530"),
                               tol);

    BOOST_CHECK_CLOSE_FRACTION(lgamma(val),
                               T("39."
                                 "3398841871994940362246523945673810816914572068978531199379699893775725549938744762493"
                                 "40525204204720861169039582"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(lgamma(val + 0),
                               T("39."
                                 "3398841871994940362246523945673810816914572068978531199379699893775725549938744762493"
                                 "40525204204720861169039582"),
                               tol);
    ...
    val = 0.125;
    BOOST_CHECK_CLOSE_FRACTION(log1p(val),
                               T("0."
                                 "1177830356563834545387941094705217050684807125647331411073486387948077205281337869296"
                                 "41528638208114949935615070"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(log1p(val + 0),
                               T("0."
                                 "1177830356563834545387941094705217050684807125647331411073486387948077205281337869296"
                                 "41528638208114949935615070"),
                               tol);
    val = 20;
    BOOST_CHECK_CLOSE_FRACTION(T(log2(val)),
                               T("4."
                                 "3219280948873623478703194294893901758648313930245806120547563958159347766086252158501"
                                 "39743359370155099657371710"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(T(log2(val + 0)),
                               T("4."
                                 "3219280948873623478703194294893901758648313930245806120547563958159347766086252158501"
                                 "39743359370155099657371710"),
                               tol);
    ...
    val = 5.25;
    tol = 3000;
    BOOST_CHECK_CLOSE_FRACTION(tgamma(val),
                               T("35."
                                 "2116118527996857052252576905312481150263111389084483140868595759012176533131456196236"
                                 "24570033258659272301335544"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(tgamma(val + 1),
                               T("184."
                                 "8609622271983499524326028752890526038881334792693536489560127734813926798940145030240"
                                 "2899267460796117958201160"),
                               tol);

    BOOST_CHECK_CLOSE_FRACTION(T(exp2(val)),
                               T("38."
                                 "0546276800870741349599990579352292893751069588421572166080711910229333832613491158650"
                                 "03025220405558913196632792"),
                               tol);
    BOOST_CHECK_CLOSE_FRACTION(T(exp2(val + 1)),
                               T("76."
                                 "1092553601741482699199981158704585787502139176843144332161423820458667665226982317300"
                                 "06050440811117826393265585"),
                               tol);
    val = 15;
    ...
    i = fpclassify(val) + isgreaterequal(val, s) + islessequal(val, s) + isnan(val) + isunordered(val, s) +
        isfinite(val) + isinf(val) + islessgreater(val, s) + isnormal(val) + signbit(val) + isgreater(val, s) +
        isless(val, s);
}
...
void test_poison() {
    ...
    i = fpclassify(a) + isgreaterequal(a, b) + islessequal(a, b) + isnan(a) + isunordered(a, b) + isfinite(a) +
        isinf(a) + islessgreater(a, b) + isnormal(a) + signbit(a) + isgreater(a, b) + isless(a, b);
#endif
#endif
}
...
void test_c99_appendix_F() {
    ...
    typename T::backend_type::exponent_type fp_ilogb0 =
        (std::numeric_limits<typename T::backend_type::exponent_type>::min)();
    typename T::backend_type::exponent_type fp_ilogbnan =
#ifdef FP_ILOGBNAN
        FP_ILOGBNAN < 0 ? (std::numeric_limits<typename T::backend_type::exponent_type>::min)() :
                          (std::numeric_limits<typename T::backend_type::exponent_type>::max)();
#else
        INT_MAX;
#endif
