            ...
            namespace commitments {
                namespace detail {
                    ...
                    std::pair<typename PointIterator::value_type, typename PointIterator::value_type>
                        merge_pairs(const PointIterator &v1_begin,
                        ...
                        typename PointIterator::value_type res1 =
                            algebra::multiexp<algebra::policies::multiexp_method_BDLO12>(
                                v1_begin, v1_end, r.begin(), r.end(), 1);

                        typename PointIterator::value_type res2 =
                            algebra::multiexp<algebra::policies::multiexp_method_BDLO12>(
                                v2_begin, v2_end, r.begin(), r.end(), 1);
                    ...
                    static std::pair<GroupValueType, GroupValueType> power_pairs(const std::vector<GroupValueType> &v) {
